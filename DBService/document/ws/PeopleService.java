 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.document/", wsdlLocation = "http://localhost:6902/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.document/", "PeopleService");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://ws.document/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.document/", "PeopleImplPort"), People.class, features);
    }
